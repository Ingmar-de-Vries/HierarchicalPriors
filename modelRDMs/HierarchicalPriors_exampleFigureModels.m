...
% It was used for creating Figure S4 in the article 

close all; clearvars; clc;
cmap = brewermap([],'*Greys');

%% set paths
vidir = '\\XXX\HierarchicalPriors\experiment\stimulil\videos';
...
% print -depsc -r600 HierarchicalPriors_figureS4_stimulusmodels.eps
