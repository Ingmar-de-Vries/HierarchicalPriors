function HierarchicalPriors_DynamicModelRDMs_kinematic(cfg,istim1,istim2)

% create dynamic RDMs from kinematic markers
% set directories
...
sampfreq = 100;
tNew = 0:1/sampfreq:5-1/sampfreq;% after jittering
...
indirKin = fullfile(rootdir,'experiment','kinematics100Hz');
...
% acceleration, then compute all RDMs
...
for itime1 = 5:size(seq1,3)-4
    ...
    for itime2 = 5:size(seq2,3)-4
        ...
        % snippets of sequence for current (=C) iteration
...
save([DataDir filesep 'HierarchicalPriors_dynRDM_posturedep_stim' num2str(istim1) '_stim' num2str(istim2)],'RDMposture_dep');
save([DataDir filesep 'HierarchicalPriors_dynRDM_postureinvar_stim' num2str(istim1) '_stim' num2str(istim2)],'RDMposture_invar');
save([DataDir filesep 'HierarchicalPriors_dynRDM_motiondep_stim' num2str(istim1) '_stim' num2str(istim2)],'RDMmotion_dep');
save([DataDir filesep 'HierarchicalPriors_dynRDM_motioninvar_stim' num2str(istim1) '_stim' num2str(istim2)],'RDMmotion_invar');
save([DataDir filesep 'HierarchicalPriors_dynRDM_accdep_stim' num2str(istim1) '_stim' num2str(istim2)],'RDMacc_dep');
save([DataDir filesep 'HierarchicalPriors_dynRDM_accinvar_stim' num2str(istim1) '_stim' num2str(istim2)],'RDMacc_invar');
...
if ~isfield(cfg,'cluster')
    ...
    for istim1 = 1:size(seqs,1)
        for istim2 = 1:size(seqs,1)
            ...
            load([DataDir filesep 'HierarchicalPriors_dynRDM_posturedep_stim' num2str(istim1) '_stim' num2str(istim2)],'RDMposture_dep');
            load([DataDir filesep 'HierarchicalPriors_dynRDM_postureinvar_stim' num2str(istim1) '_stim' num2str(istim2)],'RDMposture_invar');
            load([DataDir filesep 'HierarchicalPriors_dynRDM_motiondep_stim' num2str(istim1) '_stim' num2str(istim2)],'RDMmotion_dep');
            load([DataDir filesep 'HierarchicalPriors_dynRDM_motioninvar_stim' num2str(istim1) '_stim' num2str(istim2)],'RDMmotion_invar');
            load([DataDir filesep 'HierarchicalPriors_dynRDM_accdep_stim' num2str(istim1) '_stim' num2str(istim2)],'RDMacc_dep');
            load([DataDir filesep 'HierarchicalPriors_dynRDM_accinvar_stim' num2str(istim1) '_stim' num2str(istim2)],'RDMacc_invar');
    ...
    save([DataDir filesep 'HierarchicalPriors_dynRDM_posturedep'],'RDMposture_dep');
    save([DataDir filesep 'HierarchicalPriors_dynRDM_postureinvar'],'RDMposture_invar');
    save([DataDir filesep 'HierarchicalPriors_dynRDM_motiondep'],'RDMmotion_dep');
    save([DataDir filesep 'HierarchicalPriors_dynRDM_motioninvar'],'RDMmotion_invar');
    save([DataDir filesep 'HierarchicalPriors_dynRDM_accdep'],'RDMacc_dep');
    save([DataDir filesep 'HierarchicalPriors_dynRDM_accinvar'],'RDMacc_invar');
