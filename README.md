...
Note that the larger data files belonging to this repository are stored on a public OSF repository (DOI: [10.17605/OSF.IO/WJMVR](10.17605/OSF.IO/WJMVR); or look for Ingmar de Vries - HierarchicalPriors). The OSF repository includes: 
